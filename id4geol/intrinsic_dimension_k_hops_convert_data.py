...
if not os.path.isdir("data/k_hop_2/"):
    os.makedirs("data/k_hop_2/")

args = parser.parse_args()
if not args.destination:
    destination = "data/k_hop_2/" + args.name + ".csv"
...
###################################
# nx_graph = DatasetPool.load(args.name)
# nx_graph = from_networkx(nx_graph)
# print(type(nx_graph))
# print(nx_graph)

data = parse_npz(args.datapath+args.name+'.npz')
G = data
