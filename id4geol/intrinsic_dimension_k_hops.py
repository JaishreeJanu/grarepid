...
if not os.path.isdir("ids_estimations/fake_graphs"):
    os.makedirs("ids_estimations/fake_graphs/")

args = parser.parse_args()
if not args.destination:
    destination = "ids_estimations/fake_graphs/" + args.name + ".csv"
...
fake_graph = torch.load(args.datapath+args.name)
G = fake_graph
